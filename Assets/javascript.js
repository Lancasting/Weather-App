...
// Performing an AJAX request with the queryURL
  $.ajax({
    ...
    var temp = $("<h6>").addClass(".card-subtitle").text(temp);
    weatherResults.append(temp + " Degrees");
    var humidity = $("<h6>").addClass(".card-subtitle").text(humidity);
    weatherResults.append(humidity);
    var windSpeed = $("<h6>").addClass("card-subtitle").text(windSpeed);
    ...
    $.ajax({
      ...
      var uvIndex =$("<h6>").addClass(".card-subtitle").text(uvIndex);
